...
//sampler sampler emissiveTexSmpSC 2:24
//sampler sampler intensityTextureSmpSC 2:25
//sampler sampler opacityTexSmpSC 2:26
...
//texture texture2D baseTex 2:3:2:23
//texture texture2D emissiveTex 2:4:2:24
//texture texture2D intensityTexture 2:5:2:25
//texture texture2D opacityTex 2:6:2:26
...
//texture texture2DArray baseTexArrSC 2:36:2:23
//texture texture2DArray emissiveTexArrSC 2:37:2:24
//texture texture2DArray intensityTextureArrSC 2:38:2:25
//texture texture2DArray opacityTexArrSC 2:39:2:26
...
#if (ENABLE_RECOLOR)
{
vec3 l9_13=((recolorRed*l9_9.x)+(recolorGreen*l9_9.y))+(recolorBlue*l9_9.z);
l9_12=vec4(l9_13.x,l9_13.y,l9_13.z,l9_9.w);
}
#else
{
l9_12=l9_9;
...
#endif
float l9_17=l9_14*l9_12.w;
vec4 l9_18;
float l9_19;
#if (NODE_38_DROPLIST_ITEM==1)
{
l9_19=l9_17*tempGlobals.VertexColor.w;
l9_18=l9_12*tempGlobals.VertexColor;
}
#else
{
l9_19=l9_17;
...
#if (ENABLE_EMISSIVE)
{
vec2 l9_21=N7_getUV(NODE_76_DROPLIST_ITEM);
vec4 l9_22;
#if (emissiveTexLayout==2)
{
l9_22=sc_SampleTextureBiasOrLevel(emissiveTexDims.xy,emissiveTexLayout,emissiveTexGetStereoViewIndex(),l9_21,(int(SC_USE_UV_TRANSFORM_emissiveTex)!=0),emissiveTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex),(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0),emissiveTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0),emissiveTexBorderColor,0.0,emissiveTexArrSC);
}
#else
{
...
{
l9_23=l9_20+tempGlobals.VertexColor.xyz;
}
#else
{
l9_23=l9_20;
...
{
l9_24=ssPow((l9_23*emissiveColor)*vec3(emissiveIntensity),vec3(2.2));
}
#else
{
l9_24=l9_23;
...
#endif
vec3 l9_25=l9_18.xyz+ssPow((l9_24+vec3(0.0))+vec3(0.0),vec3(0.45454547));
...
{
l9_32=clamp(dot(l9_26.xyz,vec3(l9_19)),0.0,1.0);
}
#else
{
float l9_33;
...
{
l9_34=(1.0-dot(l9_26.xyz,vec3(0.33333001)))*l9_19;
}
#else
{
float l9_35;
...
{
l9_35=(1.0-clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0))*l9_19;
}
#else
{
float l9_36;
...
{
l9_36=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0)*l9_19;
}
#else
{
float l9_37;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_38=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0)*l9_19;
}
#else
{
float l9_39;
...
{
l9_39=dot(l9_26.xyz,vec3(0.33333001))*l9_19;
}
#else
{
float l9_40;
...
#endif
vec3 l9_53=mix(l9_51.xyz,definedBlend(l9_51.xyz,l9_26.xyz).xyz,vec3(l9_19));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_55=vec4(mix(vec3(1.0),l9_26.xyz,vec3(l9_19)),l9_19);
}
#else
{
vec4 l9_56;
